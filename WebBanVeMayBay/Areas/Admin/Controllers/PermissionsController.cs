...
namespace WebBanVeMayBay.Areas.Admin.Controllers
{
    public class PermissionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,GroupId,RoleId")] Permission permission)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,GroupId,RoleId")] Permission permission)
        {
            if (ModelState.IsValid)
            {
